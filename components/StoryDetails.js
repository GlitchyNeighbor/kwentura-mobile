    ...
    <SafeAreaView style={{ width: "100%", height: "100%" }}>
      ...
      <View style={styles.bookContainer}>
        ...
        <View>
          ...
          <View
            style={{ flexDirection: "row", marginTop: "auto", marginLeft: 10 }}
          >
      ...
      <View
        style={{ marginLeft: 18, marginTop: 10, marginRight: 18, height: 350 }}
      >
        ...
        <ScrollView style={{ height: 200, marginTop: 10 }}>
          <Text>
            Romeo the Day Dreamer grew up very sickly. But what exempts him from
            others is his ability to re-create life through his dreams, hence
            his nickname. Fernando Gonzales shatters the idea that children with
            delicate conditions are not able to experience life through their
            innocent hopes and dreams. Gonzales does not only show how one
            fragile child can inspire other kids of the same age, but also how
            supporting one another can strengthen the Filipino family.
          </Text>
        </ScrollView>
      </View>
