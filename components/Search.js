    ...
    <SafeAreaView style={{ width: "100%", height: "100%" }}>
      <View>
        ...
        >
          <View style={styles.header}>
            ...
            <View style={{flexDirection: 'row', display: 'flex', borderWidth: 1 , width: '85%', alignSelf: 'center', backgroundColor: '#d3d3d3', borderRadius: 5, borderColor: 'gray'}}>
                <TextInput
            ...
            <View style={{borderWidth: 1 , width: '85%', alignSelf: 'center', backgroundColor: 'white', borderColor: 'gray', paddingLeft: 10, paddingTop: 8, paddingRight: 10}}>
                <Text style={{color: 'gray', fontWeight: 'bold', marginBottom: 2, fontSize: 16}}>Recent</Text>
                <Text style={{color: 'gray', marginTop: 2, marginBottom: 2}}>Ang Batang Maraming Bawal</Text>
                <Text style={{color: 'gray', marginTop: 2, marginBottom: 2}}>Sandangaw</Text>
                <Text style={{color: 'gray', marginTop: 2, marginBottom: 2}}>Jack & Agyu</Text>
                <Text style={{color: 'gray', fontWeight: 'bold',marginTop: 5, marginBottom: 2, fontSize: 16}}>Suggested</Text>
                <Text style={{color: 'gray', marginTop: 2, marginBottom: 2}}>Kalipay</Text>
                <Text style={{color: 'gray', marginTop: 2, marginBottom: 2}}>When Lola Visits</Text>
                <Text style={{color: 'gray', marginTop: 2, marginBottom: 2}}>Tuko and the Birds</Text>
                <Text style={{color: 'gray', marginTop: 2, marginBottom: 2}}>Ang Alamat ng Araw at Gabi</Text>
            </View>
        </View>
      </View>
      ...
      <View style={{ paddingLeft: 10, paddingRight: 10 }}>
        <View style={{ flexDirection: "row" }}>
          ...
          <TouchableOpacity style={{ marginLeft: "auto" }}>
            <Text
              style={{ fontFamily: "sans-serif-medium", fontSize: 14}}
            >
              View All
            </Text>
          </TouchableOpacity>
      ...
      <View style={styles.navigation}>
        ...
        <TouchableOpacity style={styles.navButton}>
          <Image source={require("../icons/search-red.png")} style={styles.icons} />
