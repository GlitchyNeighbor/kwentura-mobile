  ...
  return (
    ...
    <ScrollView>
      ...
      <View style={styles.bookContainer}>
        ...
        <View>
          <Image source={require('../books/mermaid.png')}style={styles.books}/>
      ...
      <View style={styles.bookContainer}>
        ...
        <View>
        <Image source={require('../books/kalipay.png')}style={styles.books}/>
        ...
        <View>
        <Image source={require('../books/termite.png')}style={styles.books}/>
          ...
          <View style={styles.row}> 
            ...
            <View style={{ paddingLeft: 10, paddingRight: 10 }}>
        <View style={{ flexDirection: "row" }}>
          <Text style={{ fontFamily: 'sans-serif-medium', fontWeight: "bold",marginTop: 10 }}>
            Legends (Alamat)
          </Text>
      ...
      <View style={styles.bookContainer}>
        <View>
        <Image source={require('../books/matibay.png')}style={styles.books}/>
        ...
        <View>
        <Image source={require('../books/pinya.png')}style={styles.books}/>
      ...
      <View style={styles.navigation}>
            ...
            <Image source={require('../icons/category-red.png')} style={styles.icons}/>
